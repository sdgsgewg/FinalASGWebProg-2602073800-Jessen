...
<div class="card card-hover mb-3 h-100"
    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-end align-items-center text-center gap-3 mt-5">
            <form action="{{ route('followings.store') }}" method="POST" class="d-inline">
                @csrf
                <input type="hidden" name="followerId" value="{{ $user->id }}">
                <button type="submit" class="btn btn-primary btn-sm d-inline-flex">
